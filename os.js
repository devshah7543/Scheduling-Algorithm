    ...
    //LJF
        ...
        while(!(queue.length==0)){
            ...
            if(index==-1){
                ...
                table.rows[1+r].cells[5].innerHTML=time;
                table.rows[1+r].cells[4].innerHTML=time-at;
                table.rows[1+r].cells[6].innerHTML=(time-at)-max;
                addProcesses(time,processes,queue,check_pro,bt);
                if(queue.length==0){
                    let flag=0;
                    for(i=1;i<=processes;i++){
        ...
        while(!(queue.length==0)){
            ...
            if(bt[i]>0){
                if(bt[i]==Number(table.rows[2+i].cells[2].innerHTML)){
                    table.rows[2+i].cells[3].innerHTML=""+time;
                }
                ++time;
            ...
            for(i=0;i<processes;++i){
                table.rows[2+i].cells[4].innerHTML=table.rows[2+i].cells[5].innerHTML-table.rows[2+i].cells[1].innerHTML;
                table.rows[2+i].cells[6].innerHTML=table.rows[2+i].cells[4].innerHTML-table.rows[2+i].cells[2].innerHTML;
            }
        }
        calAverage(processes);
    }
